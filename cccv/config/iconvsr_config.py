...
IconVSRConfigs = [
    IconVSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/IconVSR_REDS_4x.pth",
    ...
    IconVSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/IconVSR_Vimeo90K_BD_4x.pth",
    ...
    IconVSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/IconVSR_Vimeo90K_BI_4x.pth",
