...
DATConfigs = [
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_S_2x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_S_3x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_S_4x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_2x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_3x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_4x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_2_2x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_2_3x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_2_4x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_light_2x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_light_3x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_light_4x.pth",
    ...
    DATConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/DAT_APISR_GAN_generator_4x.pth",
