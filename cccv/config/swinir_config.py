...
SwinIRConfigs = [
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_classicalSR_DF2K_s64w8_SwinIR_M_2x.pth",
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_lightweightSR_DIV2K_s64w8_SwinIR_S_2x.pth",
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_realSR_BSRGAN_DFOWMFC_s64w8_SwinIR_L_GAN_4x.pth",
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_realSR_BSRGAN_DFO_s64w8_SwinIR_M_GAN_2x.pth",
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_realSR_BSRGAN_DFO_s64w8_SwinIR_M_GAN_4x.pth",
    ...
    SwinIRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SwinIR_Bubble_AnimeScale_SwinIR_Small_v1_2x.pth",
