...
BasicVSRConfigs = [
    BasicVSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/BasicVSR_REDS_4x.pth",
        hash="543c826113a9efdc971572320a9e259833fc230f843d94f7ef7270c92b5ea4dc",
    ),
    BasicVSRConfig(
        name=ConfigType.BasicVSR_Vimeo90K_BD_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/BasicVSR_Vimeo90K_BD_4x.pth",
        hash="e9bf46ebb478abfc3002572ae67194f6b99fed5070262d75ec537f9b9df4477e",
    ),
    BasicVSRConfig(
        name=ConfigType.BasicVSR_Vimeo90K_BI_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/BasicVSR_Vimeo90K_BI_4x.pth",
