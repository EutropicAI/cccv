...
RealESRGANConfigs = [
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_RealESRGAN_x4plus_4x.pth",
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_RealESRGAN_x2plus_2x.pth",
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_realesr_animevideov3_4x.pth",
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_AniScale_2_Compact_2x.pth",
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_Ani4Kv2_Compact_2x.pth",
    ...
    RealESRGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealESRGAN_APISR_RRDB_GAN_generator_4x.pth",
