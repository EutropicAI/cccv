...
RealCUGANConfigs = [
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_Conservative_2x.pth",
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_Denoise3x_2x.pth",
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_No_Denoise_2x.pth",
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_Conservative_3x.pth",
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_Denoise3x_3x.pth",
    ...
    RealCUGANConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/RealCUGAN_Pro_No_Denoise_3x.pth",
