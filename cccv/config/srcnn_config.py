...
SRCNNConfigs = [
    SRCNNConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SRCNN_2x.pth",
        hash="e803ec6e0230ae12b1fa7fd1c67bd57d2e744b4f4fbbc861bf9790070fc4d19e",
        scale=2,
    ),
    SRCNNConfig(
        name=ConfigType.SRCNN_3x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SRCNN_3x.pth",
        hash="364ec936313d0fd1052c641b20cefd8153a2c1d89712f357f804f0119ab7ab90",
        scale=3,
    ),
    SRCNNConfig(
        name=ConfigType.SRCNN_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SRCNN_4x.pth",
