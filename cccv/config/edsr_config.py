...
EDSRConfigs = [
    ...
    EDSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Mx2_f64b16_DIV2K_official_2x.pth",
        hash="3ba7b0861913de93740110738fb621410651897e391e8057b7b6104c4f999254",
        scale=2,
    ),
    EDSRConfig(
        name=ConfigType.EDSR_Mx3_f64b16_DIV2K_official_3x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Mx3_f64b16_DIV2K_official_3x.pth",
        hash="6908f88a1be95e7112f480b7b1d9608ad83b4ffa0c227416a6376f6b036a77f3",
        scale=3,
    ),
    EDSRConfig(
        name=ConfigType.EDSR_Mx4_f64b16_DIV2K_official_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Mx4_f64b16_DIV2K_official_4x.pth",
    ...
    #     url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Lx2_f256b32_DIV2K_official_2x.pth",
    ...
    #     url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Lx3_f256b32_DIV2K_official_3x.pth",
    ...
    #     url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDSR_Lx4_f256b32_DIV2K_official_4x.pth",
