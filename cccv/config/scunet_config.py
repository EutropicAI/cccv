...
SCUNetConfigs = [
    SCUNetConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SCUNet_color_50_1x.pth",
        hash="11f6839726c10dad327a75ce578be661a3e208f01fd7ab6d3eb763a5464bfdfe",
        scale=1,
    ),
    SCUNetConfig(
        name=ConfigType.SCUNet_color_real_psnr_1x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SCUNet_color_real_psnr_1x.pth",
        hash="fa78899ba2caec9d235a900e91d96c689da71c42029230c2028b00f09f809c2e",
        scale=1,
    ),
    SCUNetConfig(
        name=ConfigType.SCUNet_color_real_gan_1x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/SCUNet_color_real_gan_1x.pth",
