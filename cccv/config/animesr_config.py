...
AnimeSRConfigs = [
    AnimeSRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/AnimeSR_v1_PaperModel_4x.pth",
        hash="915ef7f0f7067f04219516b50e88c362581300e48902e3b7f540650e32a20c10",
        scale=4,
    ),
    AnimeSRConfig(
        name=ConfigType.AnimeSR_v2_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/AnimeSR_v2_4x.pth",
