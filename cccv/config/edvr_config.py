...
EDVRConfigs = [
    ...
    EDVRConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDVR_M_SR_REDS_official_4x.pth",
        hash="32075921635eb07d56c83ec4009341bd82d882900ca7043f9c51cc7951033efd",
        scale=4,
    ),
    EDVRConfig(
        name=ConfigType.EDVR_M_woTSA_SR_REDS_official_4x,
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDVR_M_woTSA_SR_REDS_official_4x.pth",
...
EDVRFeatureExtractorConfigs = [
    ...
    EDVRFeatureExtractorConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDVRFeatureExtractor_REDS_pretrained_for_IconVSR.pth",
    ...
    EDVRFeatureExtractorConfig(
        ...
        url="https://github.com/EutropicAI/cccv/releases/download/model_zoo/EDVRFeatureExtractor_Vimeo90K_pretrained_for_IconVSR.pth",
